...
namespace DoggyChef
{
    ...
    public class Customer : MonoBehaviour
    {
        ...
        // 만족 퇴장 시 발화. HallManager가 구독하여 AddHeart()를 호출합니다.
        public Action<Customer> OnSatisfied;

        // 퇴장 완료(Destroy 직전) 시 발화. HallManager가 구독하여 스폰 슬롯을 해제합니다.
        ...
        // [HallManager 호출] 스폰 직후 초기화하고 Walkin을 시작합니다.
        // table: 배정된 테이블.
        // walkOutPos: 퇴장 목표 위치.
        // sortingOrder: 렌더링 우선순위 (테이블 인덱스 + 1).
        ...
        // [SideMenuMachine 호출] 체력을 amount만큼 회복합니다. Angry → Ordering 복귀를 포함합니다.
        ...
        // [CandyBooster 전용] 하트를 끝까지 꽉 채웁니다.
        ...
        // [Table 호출] 음식 완성 시 Eating 상태로 전환합니다.
        ...
        // [Table 호출] 식사 완료 후 만족/불만족 퇴장을 시작합니다.
        ...
        // OnHealthChanged를 발화하여 체력 UI를 갱신합니다.
        private void UpdateHealthUI()
        {
            OnHealthChanged?.Invoke(CurrentHealth, MaxHealth);
        }

        // 현재 상태에 맞는 Spine 애니메이션으로 전환합니다.
