#ifndef _CCEXTANIMATE_PACKER_H_
#define _CCEXTANIMATE_PACKER_H_
...
class CCextAnimatePacker:public CCextSingleton<CCextAnimatePacker>
{
public:
...
private:
	...
	std::map<std::string,CCextAnimate> nameToAnimateMap;
