...
protected:
	...
	SlidingMenuGridDelegate* m_delegate;
...
public:
	...
	void setClipOut(CCRect rectClip, CCNode* clipNode);
	int getCurrentPage();
	void setDelegate(SlidingMenuGridDelegate* delegate);
