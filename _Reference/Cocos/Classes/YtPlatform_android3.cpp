...
#define GET_CLASS jNativesCls = env->FindClass("com/yongtrim/lib/YtNative");
#define FREE_CLASS env->DeleteLocalRef(jNativesCls);
...
void YtPlatform_contumeProdcut()
{
	...
	jmethodID mid = env->GetStaticMethodID(jNativesCls, "contumeProdcut", "(I)V");
    
    env->CallStaticVoidMethod(jNativesCls, mid, 0);
...
void YtPlatform_NetKakao_IsLogin(YtPlatform_CallFunc callFunc)
{
	...
	jmethodID mid = env->GetStaticMethodID(jNativesCls, "NetKakaoIsLogin", "(I)V");
...
void YtPlatform_NetKakao_Logout(YtPlatform_CallFunc callFunc)
{
	...
	jmethodID mid = env->GetStaticMethodID(jNativesCls, "NetKakaoLogout", "(I)V");
...
void YtPlatform_NetKakao_Unregist(YtPlatform_CallFunc callFunc)
{
	...
	jmethodID mid = env->GetStaticMethodID(jNativesCls, "NetKakaoUnregist", "(I)V");
...
void YtPlatform_NetKakao_DeleteMe(YtPlatform_CallFunc callFunc)
{
	...
	jmethodID mid = env->GetStaticMethodID(jNativesCls, "NetKakaoDeleteme", "(I)V");
...
void YtPlatform_NetKakao_Login(int isGuest, YtPlatform_CallFunc callFunc, YtPlatform_CallFunc callFuncStart)
{
	...
	jmethodID mid = env->GetStaticMethodID(jNativesCls, "NetKakaoLogin", "(I)V");
...
void YtPlatform_NetKakao_GetUserInfo(YtPlatform_CallFuncO callFunc)
{
	...
	jmethodID mid = env->GetStaticMethodID(jNativesCls, "NetKakaoGetUserInfo", "(I)V");
...
void YtPlatform_NetKakao_GetFriends(YtPlatform_CallFuncO callFunc)
{
	...
	jmethodID mid = env->GetStaticMethodID(jNativesCls, "NetKakaoGetFriends", "(I)V");
...
void YtPlatform_NetKakao_SendMessage(YtPlatform_CallFuncO callFunc, const char* receiverID, const char* message, const char *executeURLString)
{
	...
	jmethodID mid = env->GetStaticMethodID(jNativesCls, "NetKakaoSendMessage", "(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)V");
    
    callFuncSendMessage = callFunc;
    
    jstring jstrReceiverID = env->NewStringUTF(receiverID);
    jstring jstrMessage = env->NewStringUTF(message);
    jstring jstrExecuteURLString = env->NewStringUTF(executeURLString);
    
    env->CallStaticVoidMethod(jNativesCls, mid, jstrReceiverID, jstrMessage, jstrExecuteURLString);
    
    env->DeleteLocalRef(jstrReceiverID);
    env->DeleteLocalRef(jstrMessage);
    env->DeleteLocalRef(jstrExecuteURLString);
...
void YtPlatform_NetKakao_SendPride(YtPlatform_CallFunc callFunc, const char* receiverID, const char* sender_nick, const char* score, const char* shop_name, const char* stage, const char *executeURLString)
{
	...
	jmethodID mid = env->GetStaticMethodID(jNativesCls, "NetKakaoSendPride", "(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)V");
    
    callFuncSendPride = callFunc;
    
    jstring jstrReceiverID = env->NewStringUTF(receiverID);
    jstring jstrSender_nick = env->NewStringUTF(sender_nick);
    jstring jstrScore = env->NewStringUTF(score);
    jstring jstrShop_name = env->NewStringUTF(shop_name);
    jstring jstrStage = env->NewStringUTF(stage);
    jstring jstrExecuteURLString = env->NewStringUTF(executeURLString);
    
    env->CallStaticVoidMethod(jNativesCls, mid, jstrReceiverID, jstrSender_nick, jstrScore, jstrShop_name, jstrStage, jstrExecuteURLString);
    
    env->DeleteLocalRef(jstrReceiverID);
    env->DeleteLocalRef(jstrSender_nick);
    env->DeleteLocalRef(jstrScore);
    env->DeleteLocalRef(jstrStage);
    env->DeleteLocalRef(jstrSender_nick);
    env->DeleteLocalRef(jstrExecuteURLString);
...
void YtPlatform_ShowIndicator(int enable)
{
	...
	if(!g_jShowIndicator)
		g_jShowIndicator = env->GetStaticMethodID(jNativesCls, "ShowIndicator", "(I)V");
    
    env->CallStaticVoidMethod(jNativesCls, g_jShowIndicator, enable);
...
void YtPlatform_NetKakao_LoadGameInfo(YtPlatform_CallFuncO callFunc)
{
	...
	g_VM->AttachCurrentThread(&env, NULL);
    GET_CLASS;
	jmethodID mid = env->GetStaticMethodID(jNativesCls, "NetKakaoLoadGameInfo", "(I)V");
...
void YtPlatform_NetKakao_LoadGameMe(YtPlatform_CallFuncO callFunc)
{
	...
	jmethodID mid = env->GetStaticMethodID(jNativesCls, "NetKakaoLoadGameMe", "(I)V");
...
void YtPlatform_NetKakao_LoadGameFriends(YtPlatform_CallFuncO callFunc)
{
	...
	jmethodID mid = env->GetStaticMethodID(jNativesCls, "NetKakaoLoadGameFriends", "(I)V");
...
void YtPlatform_NetKakao_LoadLeaderBoard(YtPlatform_CallFuncO callFunc, int type)
{
    ...
    GET_CLASS;
	jmethodID mid = env->GetStaticMethodID(jNativesCls, "NetKakaoLoadLeaderBoard", "(I)V");
    callFuncLoadLeaderBoard = callFunc;
    
    env->CallStaticVoidMethod(jNativesCls, mid, type);
...
void YtPlatform_NetKakao_SendData(YtPlatform_CallFunc callFunc, NetKakaSendDataType type, const char* data)
{
	...
	jmethodID mid = env->GetStaticMethodID(jNativesCls, "NetKakaoSendData", "(Ljava/lang/String;I)V");
    
    callFuncSendData = callFunc;
    
    jstring jstrData = env->NewStringUTF(data);
    
    env->CallStaticVoidMethod(jNativesCls, mid, jstrData, type);
...
void YtPlatform_NetKakao_SendGameMessage(YtPlatform_CallFuncO callFunc, const char* data)
{
	...
	jmethodID mid = env->GetStaticMethodID(jNativesCls, "NetKakaoSendGameMessage", "(Ljava/lang/String;)V");
    
    callFuncSendGameMessage = callFunc;
    
    jstring jstrData = env->NewStringUTF(data);
    
    env->CallStaticVoidMethod(jNativesCls, mid, jstrData);
...
void YtPlatform_NetKakao_AcceptMessage(YtPlatform_CallFunc callFunc, const char* messageid)
{
	...
	jmethodID mid = env->GetStaticMethodID(jNativesCls, "NetKakaoAcceptMessage", "(Ljava/lang/String;)V");
    
    callFuncAcceptMessage = callFunc;
    
    jstring jstrData = env->NewStringUTF(messageid);
...
void YtPlatform_NetKakao_AcceptAllMessages(YtPlatform_CallFunc callFunc)
{
	...
	jmethodID mid = env->GetStaticMethodID(jNativesCls, "NetKakaoAcceptAllMessages", "(I)V");
...
void YtPlatform_NetKakao_LoadGameMessages(YtPlatform_CallFuncO callFunc)
{
	...
	jmethodID mid = env->GetStaticMethodID(jNativesCls, "NetKakaoLoadGameMessages", "(I)V");
...
void YtPlatform_NetKakao_Invite(YtPlatform_CallFuncO callFunc, const char* user_id, const char* message)
{
	...
	jmethodID mid = env->GetStaticMethodID(jNativesCls, "NetKakaoInvite", "(Ljava/lang/String;Ljava/lang/String;)V");
    
    callFuncInvite = callFunc;
    
    jstring jstrUserID = env->NewStringUTF(user_id);
    jstring jstrMessage = env->NewStringUTF(message);
    
    env->CallStaticVoidMethod(jNativesCls, mid, jstrUserID, jstrMessage);
    
    env->DeleteLocalRef(jstrUserID);
    env->DeleteLocalRef(jstrMessage);
...
void YtPlatform_NetKakao_MessageBlock(YtPlatform_CallFunc callFunc, int messageBlocked)
{
	...
	jmethodID mid = env->GetStaticMethodID(jNativesCls, "NetKakaoMessageBlock", "(I)V");
    callFuncMessageBlock = callFunc;
    
    env->CallStaticVoidMethod(jNativesCls, mid, messageBlocked);
...
void YtPlatform_CopyToClipBoard(const char* user_id)
{
    ...
    jmethodID mid = env->GetStaticMethodID(jNativesCls, "CopyToClipBoard", "(Ljava/lang/String;)V");
    
    jstring jstr = env->NewStringUTF(user_id);
    env->CallStaticVoidMethod(jNativesCls, mid, jstr);
...
void YtPlatform_SendEmail(const char* user_id, const char* app_ver)
{
	...
	jmethodID mid = env->GetStaticMethodID(jNativesCls, "SendEmail", "(Ljava/lang/String;Ljava/lang/String;)V");
    
    jstring jstrUser_id = env->NewStringUTF(user_id);
    jstring jstrApp_ver = env->NewStringUTF(app_ver);
    
    env->CallStaticVoidMethod(jNativesCls, mid, jstrUser_id, jstrApp_ver);
    
    env->DeleteLocalRef(jstrUser_id);
    env->DeleteLocalRef(jstrApp_ver);
...
void YtPlatform_GoWeb(const char* strUrl)
{
	...
	jmethodID mid = env->GetStaticMethodID(jNativesCls, "GoWeb", "(Ljava/lang/String;)V");
    
    jstring jstrUrl = env->NewStringUTF(strUrl);
    
    env->CallStaticVoidMethod(jNativesCls, mid, jstrUrl);
...
void YtPlatform_GoWebView(const char* strUrl)
{
	...
	jmethodID mid = env->GetStaticMethodID(jNativesCls, "GoWebView", "(Ljava/lang/String;)V");
...
void YtPlatform_IAB(YtPlatform_CallFunc callFunc, const char* product_id, const char* payload)
{
	...
	jmethodID mid = env->GetStaticMethodID(jNativesCls, "IAB", "(Ljava/lang/String;Ljava/lang/String;)V");
    
    g_callFuncIAB = callFunc;
    
    jstring jstrUrl = env->NewStringUTF(product_id);
    jstring jstrPayload = env->NewStringUTF(payload);
    
    
    env->CallStaticVoidMethod(jNativesCls, mid, jstrUrl, jstrPayload);
    
    env->DeleteLocalRef(jstrUrl);
    env->DeleteLocalRef(jstrPayload);
...
void YtPlatform_PushOnOff(YtPlatform_CallFunc callFunc, int onoff)
{
    ...
    GET_CLASS;
	jmethodID mid = env->GetStaticMethodID(jNativesCls, "PushOnOff", "(I)V");
    callFuncPushOnOff = callFunc;
    
    env->CallStaticVoidMethod(jNativesCls, mid, onoff);
...
void YtPlatform_ShowAd(int show)
{
	...
	if(!g_jShowAd)
		g_jShowAd = env->GetStaticMethodID(jNativesCls, "ShowAd", "(I)V");
    
    env->CallStaticVoidMethod(jNativesCls, g_jShowAd, show);
...
void YtPlatform_CheckPush()
{
	...
	if(!g_jCheckPush)
		g_jCheckPush = env->GetStaticMethodID(jNativesCls, "CheckPush", "(I)V");
    
    env->CallStaticVoidMethod(jNativesCls, g_jCheckPush, 0);
...
void YtPlatform_RunBackground(int value)
{
	...
	if(!g_jRunBackground)
		g_jRunBackground = env->GetStaticMethodID(jNativesCls, "RunBackground", "(I)V");
    
    env->CallStaticVoidMethod(jNativesCls, g_jRunBackground, value);
...
void YtPlatform_CreateShort()
{
	...
	jmethodID createShort = env->GetStaticMethodID(jNativesCls, "CreateShort", "(I)V");
    
    env->CallStaticVoidMethod(jNativesCls, createShort, 0);
...
void YtPlatform_ShowNicknameView(YtPlatform_CallFuncO callFunc, const char* dafaultName, int retry)
{
	...
	jmethodID mid = env->GetStaticMethodID(jNativesCls, "ShowNicknameView", "(Ljava/lang/String;I)V");
    
    callFuncShowNicknameView = callFunc;
    
    jstring jstr = env->NewStringUTF(dafaultName);
    env->CallStaticVoidMethod(jNativesCls, mid, jstr, retry);
    env->DeleteLocalRef(jstr);
...
//
//	if(!g_mSendStr)
//		g_mSendStr = env->GetStaticMethodID(jNativesCls, "OnMessage", "(Ljava/lang/String;)V");
//	
//    jstring jstr = env->NewStringUTF(message);
//    env->CallStaticVoidMethod(jNativesCls, g_mSendStr, jstr);
//    env->DeleteLocalRef(jstr);
//}
//
//
...
//	if(mid)
//	{
//		jstring jstr = env->NewStringUTF(g_network_plat.m_strUrl);
//		env->CallStaticVoidMethod(jNativesCls, mid, jstr, g_network_plat.m_port);
//		env->DeleteLocalRef(jstr);
//	}
//	return TRUE;
//}
...
//	g_VM->AttachCurrentThread(&env, NULL);
//
//	jmethodID mid = env->GetStaticMethodID(jNativesCls, "SocketWrite", "([BI)V");
//
//	jbyteArray jArray = env->NewByteArray(nSize);
//	env->SetByteArrayRegion(jArray, 0, nSize, (jbyte *)pData);
//
//	if(mid)
//	{
//	    env->CallStaticVoidMethod(jNativesCls, mid, jArray, nSize);
//	}
//
...
//	g_VM->AttachCurrentThread(&env, NULL);
//
//	jmethodID mid = env->GetStaticMethodID(jNativesCls, "SocketClose", "(I)V");
//
//	if(mid)
//	{
//	    env->CallStaticVoidMethod(jNativesCls, mid, 0);
...
//	g_VM->AttachCurrentThread(&env, NULL);
//
//	jmethodID mid = env->GetStaticMethodID(jNativesCls, "InAppPurchase", "(Ljava/lang/String;I)V");
//
//	if(mid)
//	{
//		jstring jstrText = env->NewStringUTF(pid);
//	    env->CallStaticVoidMethod(jNativesCls, mid, jstrText, price);
...
//	g_VM->AttachCurrentThread(&env, NULL);
//
//	jmethodID mid = env->GetStaticMethodID(jNativesCls, "LibGetPhoneNumber", "(I)V");
//    env->CallStaticVoidMethod(jNativesCls, mid, 0);
//	
...
//
//	if(!g_jVibrate)
//		g_jVibrate = env->GetStaticMethodID(jNativesCls, "Vibration", "(I)V");
//
//    env->CallStaticVoidMethod(jNativesCls, g_jVibrate, millisecond);
//}
//
////
...
//	g_VM->AttachCurrentThread(&env, NULL);
//
//	jmethodID g_jCheckServer = env->GetStaticMethodID(jNativesCls, "CheckServer", "(I)V");
//
//    env->CallStaticVoidMethod(jNativesCls, g_jCheckServer, param);
//}
//
//
...
//	g_VM->AttachCurrentThread(&env, NULL);
//
//	jmethodID g_jSetTextHeight = env->GetStaticMethodID(jNativesCls, "SetTextHeight", "(I)V");
//
//    env->CallStaticVoidMethod(jNativesCls, g_jSetTextHeight, param);
//}
//
//
...
//	g_VM->AttachCurrentThread(&env, NULL);
//
//	jmethodID g_jGoProductView = env->GetStaticMethodID(jNativesCls, "GoProductView", "(I)V");
//
//    env->CallStaticVoidMethod(jNativesCls, g_jGoProductView, param);
//}
//
//
...
//	g_VM->AttachCurrentThread(&env, NULL);
//
//	jmethodID g_jGoKakao = env->GetStaticMethodID(jNativesCls, "GoKakao", "(I)V");
//
//    env->CallStaticVoidMethod(jNativesCls, g_jGoKakao, param);
//}
//
...
//	g_VM->AttachCurrentThread(&env, NULL);
//
//	jmethodID mid = env->GetStaticMethodID(jNativesCls, "DownloadStart", "(I)V");
//    env->CallStaticVoidMethod(jNativesCls, mid, 0);
//	
//	return TRUE;
//}
